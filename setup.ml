...
(* OASIS_START *)
(* DO NOT EDIT (digest: 193e5eb1fd88329d3b000f9941135f6e) *)
(*
...
let setup_t =
  {
               ...
               Test
                 ({
                     ...
                     },
                   {
                      ...
                      test_command = [(OASISExpr.EBool true, ("$bench", []))];
                      test_custom =
                        {
                           pre_command = [(OASISExpr.EBool true, None)];
                           post_command = [(OASISExpr.EBool true, None)];
                      ...
                      test_tools = [InternalExecutable "bench"];
                      });
               Doc
                 ({
                     cs_name = "doc";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\031|c\196_\209\192\243\031}\0197\207\129!\011";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
