...
(* OASIS_START *)
(* DO NOT EDIT (digest: a6bb3f41faa0e186cd52ad681700784c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://drup.github.io/LILiS/";
          synopsis = "Library to Interpret Lindenmayer Systems";
          description =
            Some "A Library to interpret, evaluate and draw L-systems.";
          categories = [];
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "tyxml",
                                OASISExpr.EAnd
                                  (OASISExpr.EFlag "cairo",
                                    OASISExpr.EFlag "glilis_ex")),
                             true)
                        ];
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("cairo2.lablgtk2", None);
                           InternalLibrary "glilis";
                           InternalLibrary "glilis.cairo";
                           InternalLibrary "glilis.tyxml"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\140\231)e\157\222`\135\249\216A\151J'\022\232";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
