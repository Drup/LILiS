...
(* OASIS_START *)
(* DO NOT EDIT (digest: fb2d8ebc58e495585511e84884c66f0a) *)
(*
...
let setup_t =
  {
     ...
     doc =
       [
          ("mini_calc", OCamlbuildDocPlugin.doc_build "mini_calc");
          ("lilis", OCamlbuildDocPlugin.doc_build "lilis")
       ];
     ...
     clean_doc =
       [
          ("mini_calc", OCamlbuildDocPlugin.doc_clean "mini_calc");
          ("lilis", OCamlbuildDocPlugin.doc_clean "lilis")
       ];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "glilis.ml"; });
               Doc
                 ({
                     cs_name = "mini_calc";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      doc_install_dir = "$htmldir/mini_calc/";
                      doc_title = "API reference for mini_calc";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "j'\174A\244\189Fz9[?\199\173P\017\154";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
