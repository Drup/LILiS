...
(* OASIS_START *)
(* DO NOT EDIT (digest: c67fdf214ab536a87e92ad34fae7d0ad) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$bench_quick", []))];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/Drup/LILiS";
          synopsis = "Library to Interpret Lindenmayer Systems";
          description =
            Some
              [
                 OASISText.Para
                   "A Library to interpret, evaluate and draw L-systems."
              ];
          categories = [];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build the Containers interface";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build the Batteries interface";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build the CFStream interface";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build the Core_kernel.Sequence interface";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Enable the cairo backend for png and gtk output";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Enable the tyxml backend for svg output";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Enable the Dom backend for js_of_ocaml";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build the executable glilis_ex.native";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Calc"; "CalcUtils"];
                      lib_pack = false;
                      lib_internal_modules = ["CalcLexer"; "CalcParser"];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Lilis"; "LisUtils"; "LisOptim"];
                      lib_pack = false;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "streams/containers";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("containers", None);
                           InternalLibrary "lilis"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                 ...
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "cfstream", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "streams/cfstream";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("threads", None);
                           FindlibPackage ("cfstream", None);
                           InternalLibrary "lilis"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                 ...
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "core_kernel", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "streams/core";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                 ...
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "batteries", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "streams/batteries";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "glilis";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "lilis"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                 ...
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "cairo", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "glilis/cairo";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "glilis";
                           FindlibPackage ("cairo2", None);
                           FindlibPackage ("cairo2.lablgtk2", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["LisCairo"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "glilis";
                      lib_findlib_name = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "tyxml", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "glilis/tyxml";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "glilis";
                 ...
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "js_of_ocaml", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "glilis/jsoo";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("js_of_ocaml.graphics", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "cairo",
                                OASISExpr.EAnd
                                  (OASISExpr.EFlag "executable",
                                    OASISExpr.EFlag "containers")),
                             true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "glilis/executable";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "glilis_ex.ml"});
               Library
                 ({
                     cs_name = "bench_common";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "bench_common"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "bench_streams.ml"});
               Executable
                 ({
                     cs_name = "bench_vonkoch";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "bench_vonkoch.ml"});
               Executable
                 ({
                     cs_name = "bench_quick";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "bench_quick.ml"});
               Executable
                 ({
                     cs_name = "bench_optims";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "bench_optims.ml"});
               Test
                 ({
                     cs_name = "bench_quick";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "bench_quick"
                        ]
                   });
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for LILiS";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "https://github.com/Drup/LILiS.git";
                      src_repo_browser = Some "https://github.com/Drup/LILiS";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\023;\141\172O\161\2132\165]\129\190\179\186o\190";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
