(* OASIS_START *)
(* DO NOT EDIT (digest: a81b7ce55d1f58b795e5641c89a4a73c) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ...
          ("cfstream", ["streams/cfstream"], []);
          ("core_kernel", ["streams/core"], []);
          ("batteries", ["streams/batteries"], []);
          ("glilis", ["glilis"], []);
          ("cairo", ["glilis/cairo"], []);
          ("tyxml", ["glilis/tyxml"], []);
          ("jsoo", ["glilis/jsoo"], []);
     ...
     includes =
       [
          ("test", ["lilis"; "streams/containers"]);
          ("streams/core", ["lilis"]);
          ("streams/containers", ["lilis"]);
          ("streams/cfstream", ["lilis"]);
          ("streams/batteries", ["lilis"]);
          ("lilis", ["calc"]);
          ("glilis/tyxml", ["glilis"]);
          ("glilis/jsoo", ["glilis"]);
          ("glilis/executable",
            ["glilis"; "glilis/cairo"; "streams/containers"]);
          ("glilis/cairo", ["glilis"]);
          ("glilis", ["lilis"])
       ]
  }
...
let bench_opt_dep =
  ["batteries"; "containers" ; "core_kernel" ; "cfstream" ]
